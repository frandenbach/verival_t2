...
public class EstatisticaNormalIntegrationTest {
    ...
    public void testEstatisticaNormalIntegration() {
        ...
        EstatisticasDTO estatisticasDTO = servicoEstatistica.calculaEstatisticas(21000);

        assertEquals(4720, estatisticasDTO.getMedia(), 0.001);
        assertEquals(4720, estatisticasDTO.getMediana(), 0.001);
        assertEquals(200, estatisticasDTO.getDesvioPadrao(), 0.001);
    }
}
